  ...
  interface State {
    ...
    function renderHome() {
      ...
      const heading = (body: string): string => '<section class="view"><div class="heading"><div class="headmain"><h1>'
        ...
        + '<div class="inline-actions">' + button({ label: "Full report", on: { "data-page": "answer-engine" } }) + ''
