...
import { renderCiteGeoLockupInline } from "./brand.js";

const phase5BrandLockup = renderCiteGeoLockupInline("p5-brandlockup");
...
(() => {
  ...
  const requestButton = (label, action, primary) => '<button type="button" class="btn' + (primary ? " btn-primary" : "") + '" data-action="' + esc(action) + '">' + esc(label) + "</button>";
  ...
  const css = () => '<style>' +
    '#app{min-height:100vh;background:var(--paper);color:var(--text);font:14px var(--font-ui);font-variant-numeric:tabular-nums}.p5-shell{display:grid;grid-template-columns:248px minmax(0,1fr);min-height:100vh;background:linear-gradient(90deg,var(--sunken) 0 247px,var(--line) 247px 248px,transparent 248px)}.p5-side{position:sticky;top:0;height:100vh;box-sizing:border-box;background:var(--sunken);border-right:1px solid var(--line);padding:20px 16px}.p5-brand{display:flex;align-items:center;margin:4px 8px 24px}.p5-brandlockup{display:inline-flex;align-items:center;gap:8px;color:var(--text)}.p5-brandlockup .brand-mark-svg{width:24px;height:24px;display:block;color:var(--accent)}.p5-brandlockup .brand-word{font-family:var(--font-display);font-size:20px;font-weight:600;letter-spacing:-0.02em}.p5-label{color:var(--weak);font-size:11px;letter-spacing:.08em;text-transform:uppercase;margin:18px 8px 8px}.p5-input,.p5-select{box-sizing:border-box;width:100%;border:1px solid var(--line);border-radius:8px;background:var(--surface);color:var(--text);padding:10px}.p5-nav{display:grid;gap:3px;margin-top:12px}.p5-nav button{border:0;background:transparent;color:var(--muted);text-align:left;border-radius:8px;padding:10px 12px;cursor:pointer}.p5-nav button.active,.p5-nav button:hover,.p5-nav button:focus-visible{color:var(--text);background:var(--raised)}.p5-main{min-width:0}.p5-header{position:sticky;top:0;z-index:4;height:70px;display:flex;align-items:center;justify-content:space-between;gap:12px;padding:0 30px;border-bottom:1px solid var(--line);background:var(--paper)}.p5-content{max-width:1700px;padding:30px}.p5-heading{display:flex;align-items:flex-start;justify-content:space-between;gap:20px}.p5-heading h1{font-family:var(--font-display);font-weight:800;letter-spacing:-0.01em;font-size:28px;margin:0 0 7px}.p5-muted{margin:0;color:var(--muted);line-height:1.5}.p5-actions{display:flex;flex-wrap:wrap;justify-content:flex-end;gap:8px}.p5-alert,.p5-card,.p5-chart,.p5-modal,.p5-drawer,.p5-empty{border:1px solid var(--line);border-radius:8px;background:var(--surface)}.p5-alert{padding:15px 18px;border-left:3px solid var(--unknown);margin:18px 0}.p5-alert strong{display:block;margin-bottom:4px}.p5-grid{display:grid;grid-template-columns:repeat(4,minmax(0,1fr));gap:12px;margin-top:18px}.p5-card{padding:16px;min-height:102px}.p5-cardwide{grid-column:1/-1}.p5-card:hover{border-color:var(--line-strong)}.p5-card span{color:var(--muted)}.p5-card strong{display:block;margin-top:10px;font-size:22px}.p5-section{margin-top:28px;scroll-margin-top:88px}.p5-section h2{font-family:var(--font-display);font-weight:700;letter-spacing:-0.01em;font-size:18px;margin:0 0 6px}.p5-chart{padding:18px;margin-top:14px}.p5-charthead{display:flex;justify-content:space-between;gap:16px}.p5-charthead .btn{align-self:flex-start}.p5-chart h3{font-family:var(--font-display);font-weight:700;margin:0 0 6px;font-size:16px}.p5-formula{color:var(--muted);font-family:var(--font-mono);font-size:12px}.p5-chart svg{width:100%;height:230px;display:block;margin:10px 0 0}.p5-axis{stroke:var(--line);stroke-width:1}.p5-axis-label{fill:var(--muted);font-size:11px}.p5-line{fill:none;stroke-width:3;stroke-linecap:round;stroke-linejoin:round}.p5-line.draw{stroke-dasharray:var(--path-length);stroke-dashoffset:var(--path-length);animation:p5draw 650ms cubic-bezier(.22,1,.36,1) forwards}.p5-point{stroke-width:3;cursor:pointer;transition:transform 140ms ease}.p5-point.partial{stroke-dasharray:3 2}.p5-pointbutton:focus-visible .p5-point,.p5-pointbutton:hover .p5-point{transform:scale(1.65)}.p5-pointbutton .p5-latest{stroke:currentColor;stroke-width:5;stroke-opacity:.35}.p5-legend{display:flex;flex-wrap:wrap;gap:12px;color:var(--muted);margin-top:8px}.p5-legend i{display:inline-block;width:9px;height:9px;border-radius:50%;margin-right:5px}.p5-table{width:100%;border-collapse:collapse;margin-top:12px}.p5-table th,.p5-table td{text-align:left;vertical-align:top;padding:9px 8px;border-bottom:1px solid var(--line)}.p5-table td{font-family:var(--font-mono);font-size:12px}.p5-table th{color:var(--muted);font-weight:600}.p5-table-detail{margin-top:12px;color:var(--muted)}.p5-table-detail summary{cursor:pointer}.p5-empty{margin-top:18px;padding:18px;color:var(--muted)}.p5-emptyall strong{display:block;color:var(--text);margin-bottom:6px}.p5-metriclist{display:grid;grid-template-columns:repeat(auto-fill,minmax(270px,1fr));gap:2px 18px;margin:12px 0 0;padding-left:18px;font-size:13px}.p5-modalwrap{position:fixed;inset:0;z-index:10;padding:18px;display:grid;place-items:center;background:color-mix(in srgb, var(--text) 34%, transparent)}.p5-modal{width:min(580px,100%);max-height:calc(100vh - 36px);overflow:auto;padding:20px}.p5-modal-head{position:sticky;top:-20px;z-index:1;display:flex;align-items:center;justify-content:space-between;gap:12px;margin:-20px -20px 16px;padding:16px 20px 12px;background:var(--surface);border-bottom:1px solid var(--line)}.p5-modal-head h2{font-family:var(--font-display);font-weight:700;margin:0}.p5-row{display:grid;grid-template-columns:1fr 1fr;gap:10px;margin:12px 0}.p5-check{display:flex;align-items:center;gap:8px;padding:8px 0}.p5-drawer{position:fixed;right:18px;top:88px;z-index:9;width:min(550px,calc(100vw - 36px));max-height:calc(100vh - 106px);overflow:auto;padding:18px;box-shadow:0 18px 50px color-mix(in srgb, var(--text) 22%, transparent);animation:p5slide 200ms ease-out}.p5-drawer pre{white-space:pre-wrap;word-break:break-word;background:var(--sunken);border:1px solid var(--line);border-radius:6px;padding:12px}.p5-status{font-size:12px;color:var(--muted)}.p5-saved{margin:18px 0 0;color:var(--confirmed-text);font-size:13px}.p5-ok{color:var(--confirmed-text)}.p5-warn{color:var(--unknown-text)}.p5-bad{color:var(--failed-text)}.p5-tag{display:inline-block;border:1px solid var(--line-strong);border-radius:999px;padding:3px 7px;margin:2px;color:var(--muted);font-size:12px}@keyframes p5draw{to{stroke-dashoffset:0}}@keyframes p5spin{to{transform:rotate(360deg)}}@keyframes p5slide{from{transform:translateX(16px);opacity:0}to{transform:translateX(0);opacity:1}}@media(max-width:900px){.p5-shell{grid-template-columns:1fr}.p5-side{position:relative;height:auto;border-right:0;border-bottom:1px solid var(--line)}.p5-nav{grid-template-columns:repeat(3,minmax(0,1fr))}.p5-header{padding:0 18px}.p5-content{padding:18px}.p5-grid{grid-template-columns:repeat(2,minmax(0,1fr))}}@media(prefers-reduced-motion:reduce){*,*::before,*::after{animation-duration:.01ms!important;transition-duration:.01ms!important}}</style>';
  async function load() {
    state.loading = true;
    render();
    try {
  ...
  const controlsFor = (definition) => definition[4] === "discovery"
    ? '<div class="p5-actions"><button class="btn" data-view-metric="brand_name_mention" ' + (state.discoveryMetric === "brand_name_mention" ? "disabled" : "") + '>Brand name</button><button class="btn" data-view-metric="domain_body_mention" ' + (state.discoveryMetric === "domain_body_mention" ? "disabled" : "") + '>Domain in answer body</button></div>'
    : definition[4] === "association"
      ? '<div class="p5-actions"><button class="btn" data-view-metric="keyword_association_count" ' + (state.associationMetric === "keyword_association_count" ? "disabled" : "") + '>Association count</button><button class="btn" data-view-metric="keyword_association_coverage" ' + (state.associationMetric === "keyword_association_coverage" ? "disabled" : "") + '>Association coverage</button><button class="btn" data-view-metric="keyword_relative_weight" ' + (state.associationMetric === "keyword_relative_weight" ? "disabled" : "") + '>Relative weight</button></div>'
      : "";
  ...
  const configurationSummary = () => {
    ...
    const action = status === "unchanged" ? '<button class="btn" disabled>✓ Current configuration saved</button>' : requestButton(status === "changed" ? "Save as a new configuration" : "Save configuration", "save-configuration");
  ...
  const createModal = () => modalShell('<form class="p5-modal" data-form="project" role="dialog" aria-modal="true">' + modalHeader("New project") + '<p class="p5-muted">Each project is bound to its own domain, models, scope, runs and tasks.</p><label>Domain<input class="p5-input" name="domain" required placeholder="example.com"></label><label>Project name<input class="p5-input" name="name" placeholder="Optional"></label><div class="p5-actions" style="margin-top:16px">' + requestButton("Cancel", "close") + '<button class="btn btn-primary" type="submit">Create draft project</button></div></form>');
  ...
  const render = () => {
    ...
    const headerAction = state.loading ? '<button type="button" class="btn btn-primary" disabled>Loading…</button>' : requestButton("New project", "create", true);
  ...
  const perform = async (button, label, job) => {
    ...
    button.dataset.actionState = "loading"; button.textContent = "◌ " + label + "…"; button.disabled = true;
    try { await job(); button.dataset.actionState = "success"; button.textContent = "✓ Completed"; window.setTimeout(load, 800); }
    catch (_) { state.error = "The action did not complete. Check this project\'s configuration, scope, models, budget or task status."; button.dataset.actionState = "error"; button.textContent = "Action failed · retry"; button.disabled = false; render(); }
  };
