...
function outputFor(modelId: string): string {
  if (modelId === "fixture/model-b") {
    return JSON.stringify({
      ...
      competitors: [],
      brandKeywords: [],
      unknowns: ["target.example could not be confirmed in this run."],
    });
  }
  if (modelId === "fixture/model-c") {
    return JSON.stringify({
      ...
      businessDescription: { value: "Team knowledge base tool", citationUrls: ["https://source.example/forge"] },
      productCategory: { value: "Collaboration tool", citationUrls: [] },
      competitors: [
      ...
      brandKeywords: [{ keyword: "API Docs", citationUrls: ["https://source.example/forge"] }, { keyword: "Site search", citationUrls: [] }],
      unknowns: [],
    });
  }
  return JSON.stringify({
    ...
    businessDescription: { value: "Developer documentation tool", citationUrls: [] },
    productCategory: { value: "Developer tool", citationUrls: [] },
    competitors: [
    ...
    brandKeywords: [{ keyword: "API Docs", citationUrls: [] }, { keyword: "Open-source docs", citationUrls: [] }],
    unknowns: [],
  });
}
